...
from comparison.run_pymoo.problem import load_instance, solve
...
def run_once(
    ...
    expected_vehicle_capacity = max_expected_load(ev_params["vehicle_capacity"], beta, alpha)
    print(expected_vehicle_capacity)
    problem = load_instance(
        file_path=instance_path,
        beta=beta,
        expected_vehicle_capacity=expected_vehicle_capacity,
...
if __name__ == "__main__":
    ...
    run_once(file_path,0.1,0.9,ev_params,"cmopso",1,1,1)
